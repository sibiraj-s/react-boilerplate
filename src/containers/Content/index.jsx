  ...
  return (
    <div className="flex h-full min-h-screen flex-col justify-center px-4 text-black dark:text-white sm:items-center">
      <div className="mb-3">
        ...
        <p className="sm:text-center text-sm mt-1 text-gray-600 dark:text-gray-300">
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        >
          <img
            src="https://badgen.net/badge/github/sibiraj-s?icon&color=red"
            alt="Sibiraj @ Github"
          />
        </a>
        <a
        ...
        >
          <img
            src="https://badgen.net/badge/github/react-boilerplate?icon&label"
        ...
        >
          <img
            src="https://badgen.net/github/license/sibiraj-s/react-boilerplate?color=green"
            alt="MIT"
          />
        </a>
      </div>
